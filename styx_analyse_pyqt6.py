...
def resource_path(relative_path):
    """Retourne le chemin absolu vers une ressource (image, json, etc.)."""
    if getattr(sys, 'frozen', False):  # si lancé depuis un .app (py2app ou pyinstaller)
        base_path = os.path.dirname(sys.argv[0])  # = Contents/MacOS
...
class HomePage(QWidget):
    ...
    def init_ui(self):
        ...
        version_label = QLabel(f"STYX Analyse {APP_VERSION}")
        ...
        """)
        version_label.setAlignment(Qt.AlignmentFlag.AlignRight)  # Aligné à droite en bas

        #left_layout.addWidget(version_label)               #ajouté plus tard
        ...
        """)
        support_btn.clicked.connect(lambda: QDesktopServices.openUrl(QUrl("https://styx-projet.fr/styx-analyse#styx-analyse-pc")))
        ...
        logo_title = QLabel()
        logo_pixmap = QPixmap(resource_path("images/logo_styx_blanc_2.png"))
        ...
        left_layout.addWidget(support_btn, alignment=Qt.AlignmentFlag.AlignRight)
        left_layout.addWidget(version_label)
        left_layout.addStretch()
        left_panel.setLayout(left_layout)

        # === PANNEAU DROIT avec image de fond ===
        right_panel = BackgroundWidget(resource_path("images/Image_Fond.png"))
...
class AnalysisPage(QWidget):
    ...
    def init_ui(self):
        ...
        # Header
        self.original_logo_pixmap = QPixmap(resource_path("images/logo_styx_blanc.png"))
